...
//    anchors.fill: selectedBackgroundImage
    ...
    Image
    {
        ...
        source: "qrc:/res/background_select_fill_sample.png"
        visible: false
        opacity: 0.6
        smooth: true
        fillMode: Image.Tile
    ...
    MouseArea
    {
        ...
        onEntered: { borderImage.source = "qrc:/res/BorderSelected.png"; buttonText.color = Settings.selectedColor; selectedBackgroundImage.visible = true}//filter_rectangle.state = "Hovered"
        onExited: { borderImage.source = "qrc:/res/BorderDefault.png"; buttonText.color = Settings.defaultColor; selectedBackgroundImage.visible = false }//customButton.state = "Default"
